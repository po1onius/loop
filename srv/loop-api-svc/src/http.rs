...
impl ErrorCode {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::EventJoinRequestNotFound => "event_join_request_not_found",
...
pub mod err_key {
    ...
    pub const EVENT_JOIN_REQUEST_NOT_FOUND: ErrorCode = ErrorCode::EventJoinRequestNotFound;
